			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<div class="col-lg-4">
								...
								<input class="btn btn-default btn-xs" type="button" value="ID 중복체크" style="margin-top: 5px">
								<label name="result-idcheck" type="label" style="margin-top:3px; color: red;"><h6>중복확인결과 출력</h6></label>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input class="btn btn-default btn-sm" type="button" value="주소 찾기" style="margin-top: 5px">
							</div>
						</div>
						<div class="form-group">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" data-toggle="modal" href="#join_sc_modal" data-dismiss="modal">회원가입</button>
					</div>
				</div>
			</div>
		</form>
		...
		<form class="form-horizontal" role="form">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							<h2 style="text-align: center;">가입을 축하드립니다</h2>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">닫기</button>
						<button type="button" class="btn btn-primary" data-toggle="modal" href="#loginModal" data-dismiss="modal">로그인하기</button>
					</div>
				</div>
			</div>
		</form>
